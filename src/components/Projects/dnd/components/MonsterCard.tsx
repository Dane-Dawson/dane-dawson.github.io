...
const MonsterCard: React.FC<MonsterCardProps> = ({ monster }) => {
  const abilityData = [
    {
      subject: "STR",
      value: monster.STR,
      modifier: monster.STR_mod,
      fullMark: 30,
    },
    {
      subject: "DEX",
      value: monster.DEX,
      modifier: monster.DEX_mod,
      fullMark: 30,
    },
    {
      subject: "CON",
      value: monster.CON,
      modifier: monster.CON_mod,
      fullMark: 30,
    },
    {
      subject: "INT",
      value: monster.INT,
      modifier: monster.INT_mod,
      fullMark: 30,
    },
    {
      subject: "WIS",
      value: monster.WIS,
      modifier: monster.WIS_mod,
      fullMark: 30,
    },
    {
      subject: "CHA",
      value: monster.CHA,
      modifier: monster.CHA_mod,
      fullMark: 30,
    },
  ];
  ...
  const formatMonsterText = (text: string) => {
    ...
    formattedText = formattedText.replace(
      patterns[3],
      '<small style="color: #d4af37; font-weight: bold;">$1</small>'
    );
    ...
    <div className="monster-card">
          ...
          <div className="monster-stats-banner">
            <div className="stat-item">
              ...
              <span className="value">
                {monster["Armor Class"]} ({monster.armor_type})
              </span>
            </div>
            <div className="stat-item">
              <span className="label">Hit Points</span>
              <span className="value">
                {monster["Hit Points"]} ({monster.hit_point_die})
              </span>
            </div>
            <div className="stat-item">
      ...
      <div className="monster-sections">
          ...
          <details className="monster-collapsible" open>
            ...
            <div className="collapsible-content">
              {monster.Traits.map((trait, i) => (
                <p
                  key={`trait-${i}`}
                  dangerouslySetInnerHTML={{ __html: formatMonsterText(trait) }}
                />
              ))}
            </div>
          </details>
              ...
              {monster.Actions.map((action, i) => (
                <p
                  ...
                  dangerouslySetInnerHTML={{
                    __html: formatMonsterText(action),
                  }}
                />
              ))}
            </div>
        ...
        {monster["Legendary Actions"] &&
          monster["Legendary Actions"].length > 0 && (
            <details className="monster-collapsible">
                ...
                {monster["Legendary Actions"].map((lAction, i) => {
                  ...
                  return (
                    <p
                      ...
                      dangerouslySetInnerHTML={{
                        __html: formatMonsterText(lAction),
                      }}
                    />
                  );
                })}

...
export const handleTerminalDisplay = (
...
const commandsListPTag = () => (
  <p className="terminal-commands">{commandsArray.join(" || ")}</p>
);
...
export const commands = () => {
  return (
    <div>
      ...
      <p>...</p>
      <br />
      <p className="terminal-display commands-1">
        Seriously? It was literally on the screen a second ago.
      </p>
      <p className="terminal-display commands-2">
        I know devs don't read documentation, but come on now.
      </p>
      <br />
...
export const help = () => {
  return (
    <div>
      <p className="terminal-display">
        I mean...I wish I could, I need some myself!
      </p>
      <br />
...
export const limmerick = () => {
  return (
    <div>
      <p className="terminal-display limmerick-1">
        There once was a coder who came
      </p>
      <p className="terminal-display limmerick-2">
        to a site engineered by a Dane.
      </p>
      ...
      <p className="terminal-display limmerick-5">
        but be gentle to cause him no pain.
      </p>
      <br />
      <br />
...
export const terminalInput = (
  commandLine: string | number | readonly string[] | undefined,
  handleChange: {
    (event: any): void;
    (arg0: ChangeEvent<HTMLInputElement, HTMLInputElement>): void;
  }
) => {
  return (

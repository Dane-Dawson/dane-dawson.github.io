...
const Projects = () => {
  const myProjects: Project[] = [
    ...
    },
    {
      ...
      description:
        "A series of playful, interactive React modules designed to reinforce foundational concepts like state management and component lifecycles.",
    ...
    },
    {
      ...
      description:
        "A technical sandbox for mastering core JavaScript fundamentals including complex DOM manipulation, asynchronous fetch() calls, and event handling.",
    ...
    },
    {
      ...
      description:
        "A comprehensive guide and boilerplate for building and personalizing mock REST APIs for rapid frontend prototyping.",
    ...
    },
    {
      ...
      description:
        "A Ruby on Rails API blueprint for secure token-based authentication, designed to integrate seamlessly with modern React frontends.",
    ...
    },
    {
      ...
      description:
        "The frontend counterpart to the Rails Auth API, demonstrating secure login flows, protected routing, and session persistence.",
    ...
    },
    {
      ...
      description:
        "A curated collection of structured data sets tailored for JSON-server environments to simulate real-world database responses.",
        ...
        {myProjects.map((project, index) => (
          <div key={index} className="project-card">
            ...
            <div className="project-actions">
              ...
              {project.demoUrl && (
                <button
                  onClick={(e) => handleOpenDemo(e, project.demoUrl!)}

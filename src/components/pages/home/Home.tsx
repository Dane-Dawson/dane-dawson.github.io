      ...
      <div className="general-info-div">
        ...
        <img className="info-image" src={skyline} />
          <p className="info-blurb">
            Born and raised in Austin, Texas, my life has been an adventurous forray into a myriad of experiences thusfar (at least, in my humble opinion). With a lifetime of diverse hobbies and jobs, many browsable below, I've long since made the career shift into tech. I started my experience working with initial experience at SignUp, primarily focusing on backend testing. I then was given the opportunity to teach code at Flatiron, and ended up most recently at a role at The Home Depot. I have been thankful for the opportunity to find a unique field that is a meeting point for creativity, problem solving, and communication.
          </p>
        </div>
